  ...
  return (
    <div className="min-h-screen bg-white dark:bg-sentinel-dark-bg text-black dark:text-white px-4 py-6 md:py-8">
      <div className="max-w-5xl mx-auto space-y-4">
        ...
        <section className="rounded-3xl border border-sentinel-green/20 bg-black/10 dark:bg-sentinel-dark-card p-5 space-y-2">
        ...
        <section className="rounded-3xl border border-sentinel-green/20 bg-black/10 dark:bg-sentinel-dark-card p-4 md:p-5 flex flex-col min-h-[70vh]">
          ...
          <form onSubmit={handleSend} className="mt-3 pt-3 border-t border-sentinel-green/20 flex gap-2">
